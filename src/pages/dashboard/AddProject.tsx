    ...
    <div className="w-full h-full flex flex-col">
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <img src={RocketIcon} alt="" className="w-5 h-5" />
            Invite Member
          </Button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 md:p-8 shadow-sm flex-1 flex flex-col">
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-2">
            <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
              <img src={RocketIcon} alt="" className="w-6 h-6" />
            </div>
            <div>
        ...
        >
          ...
          <div className="flex items-center justify-between pt-6 border-t border-slate-light/30">
            <Button
              type="button"
              variant="surface"
      ...
      <div className="mt-4 bg-primary-light rounded-lg p-4">
        <div className="flex items-start gap-2 text-body-sm text-slate-medium">
          ...
          <p>
            <strong className="text-slate-dark">Pro Tip:</strong> You can invite
